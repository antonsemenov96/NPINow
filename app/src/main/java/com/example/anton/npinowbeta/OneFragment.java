...
public class OneFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // делаем повеселее
        //mSwipeRefreshLayout.setColorScheme(R.color.Lec, R.color.green, R.color.yellow, R.color.red);
    ...
    private class Update extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String strJson) {
            ...
            else
            {
                ...
                rv.setAdapter(new AlphaInAnimationAdapter(adapter));
                mSwipeRefreshLayout.setRefreshing(false);
                Fragment activeFragment = getFragmentManager().getFragments().get(1);
                ((TomFragment)activeFragment).FromActivityRefresh();
            }
        }
    }
}